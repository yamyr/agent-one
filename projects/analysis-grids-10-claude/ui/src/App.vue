...
import WorldMap3d from './components/3DWorldMap.vue'
...
const viewType = ref('2d')  // '2d' or '3d'
...
function toggleViewType() {
  viewType.value = viewType.value === '2d' ? '3d' : '2d'
}
    ...
    <div class="top-row">
      <div class="left-col">
        ...
        <div class="follow-bar">
          <span class="follow-label">View:</span>
          <button
            class="view-btn"
            :class="{ active: viewType === '2d' }"
            @click="viewType = '2d'"
          >
            2D Map
          </button>
          <button
            class="view-btn"
            :class="{ active: viewType === '3d' }"
            @click="viewType = '3d'"
          >
            3D View
          </button>
          <span class="follow-label" style="margin-left: 1rem;">Follow:</span>
          <button
