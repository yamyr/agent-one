...
class MistralRoverReasoner:
    ...
    def _build_context(self):
        ...
        parts.append(
            ...
            f"Storm level: {WORLD['environment']['storm_level']} ({'ACTIVE' if WORLD['environment']['storm_active'] else 'CLEAR'})\n"
            f"Visibility: {WORLD['environment']['visibility']:.0%}\n"
            f"Temperature: {WORLD['environment']['temperature']}°C\n"
