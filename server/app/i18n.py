...
RAW_TRANSLATIONS = {
    ...
    "header.reset": {"en-US": "RESET", "zh-Hans": "重置", "zh-Hant": "重設", "ta-IN": "மீட்டமை", "ml-IN": "റീസെറ്റ്", "ja-JP": "リセット"},
    "header.pause": {"en-US": "PAUSE", "zh-Hans": "暂停", "zh-Hant": "暫停", "ta-IN": "இடைநிறுத்து", "ml-IN": "താൽക്കാലിക നിർത്തൽ", "ja-JP": "一時停止"},
    "header.resume": {"en-US": "RESUME", "zh-Hans": "继续", "zh-Hant": "繼續", "ta-IN": "தொடர்", "ml-IN": "തുടരുക", "ja-JP": "再開"},
    "status.connected": {"en-US": "CONNECTED", "zh-Hans": "已连接", "zh-Hant": "已連線", "ta-IN": "இணைந்தது", "ml-IN": "കണക്റ്റഡ്", "ja-JP": "接続中"},
    "status.disconnected": {"en-US": "DISCONNECTED", "zh-Hans": "未连接", "zh-Hant": "未連線", "ta-IN": "துண்டிக்கப்பட்டது", "ml-IN": "ഡിസ്കണക്റ്റഡ്", "ja-JP": "未接続"},
    ...
    "world.aria_map": {"en-US": "Interactive world map. Drag or use keyboard arrows/WASD to pan, mouse wheel to zoom."},
    "world.connecting": {"en-US": "Connecting to satellite feed..."},
    "world.agent_tooltip": {"en-US": "{id} [{type}]\nPosition: {pos}\nBattery: {bat}%\nTiles visited: {visited}"},
